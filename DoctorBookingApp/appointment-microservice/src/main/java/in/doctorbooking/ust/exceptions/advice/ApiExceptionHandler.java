...
import in.doctorbooking.ust.exceptions.AppointmentAlreadyExistsException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleDcotorNotFoundException(AppointmentNotFoundException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
    @ExceptionHandler(AppointmentAlreadyExistsException.class)
    protected ResponseEntity<Object> handleDoctorNotFoundException(AppointmentAlreadyExistsException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
